...
// Function to render elements in a grid
...
// Render main elements and series
renderElements('.main-table', mainElements);
renderElements('.lanthanide-series', lanthanides);
renderElements('.actinide-series', actinides);

// // Render elements dynamically
// function renderElements(containerSelector, elements, useGrid) {
//     const container = document.querySelector(containerSelector);
//     elements.forEach(element => {
//         const item = document.createElement("div");
//     });
